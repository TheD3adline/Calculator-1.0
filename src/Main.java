...
public class Main {
    public static void main(String[] args) {            //First real practice project, a little calculator app, only the 4 basic math operations in a console environment,
        ...
        while(loop == true) {
            ...
            switch(input) {
                case "m": number1 = 0.0; number2 = 0.0; break;    //the switch branching to access the memory array and inject one of its double data as number 1 to be calculated, to be implemented
            ...
            input = sc.next();
            switch(input) {
                case "m": number1 = 0.0; number2 = 0.0; break;
            ...
            System.out.println("Do you want to perform another calculation? Press y for yes or x to exit program: ");        //Asks if the program is to be exited (or terminated, remember to loop that later) or if another calculation loop is to be performed
            input = sc.next();
            switch(input) {
